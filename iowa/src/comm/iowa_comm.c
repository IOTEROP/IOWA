...
void commClose(iowa_context_t contextP)
{
    ...
    {
        iowa_system_connection_close(contextP->commContextP->channelArray[i]->connP, contextP->userData);
        iowa_system_free(contextP->commContextP->channelArray[i]);
    }

    iowa_system_free(contextP->commContextP->channelArray);
    iowa_system_free(contextP->commContextP);
