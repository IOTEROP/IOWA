...
This is the Simple Client featuring an additional IPSO Temperature Object (ID: 3303).
...
### Initialization
 ...
 This step is the same as in the Simple Client sample.
...
The Simple Client sample was letting IOWA run for two minutes before exiting. Here, during these two minutes, we let IOWA for three seconds then we update the sensor value.
...
This step is the same as in the Simple Client sample with one additional function call:
