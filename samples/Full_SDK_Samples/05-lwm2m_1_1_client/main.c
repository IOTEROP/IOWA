...
/**************************************************
 *
 * This is a simple LwM2M 1.1 Client demonstrating
 * IOWA ease-of-use.
 *
 **************************************************/
...
static void prv_generate_unique_name(char *name)
{
    ...
    sprintf(name, "IOWA_sample_client_1_1_%ld", id);
}
         ...
         char *argv[])
{
    ...
    printf("This a simple LwM2M 1.1 Client.\r\n\n");
    ...
    devInfo.modelNumber = "lwm2m_1_1_client";
