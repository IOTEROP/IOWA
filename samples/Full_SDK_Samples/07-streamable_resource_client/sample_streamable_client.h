 ...
 * | 5750 | String  |   R/W      | Single   | A writable string (streamable)      |
...
#define SAMPLE_OBJECT_BOOLEAN_RES_ID 5500
#define SAMPLE_OBJECT_STRING_RES_ID  5750
#define SAMPLE_OBJECT_INTEGER_RES_ID 5503

#define SAMPLE_RES_DESCRIPTION {                                                                                                                                       \
    {SAMPLE_OBJECT_BOOLEAN_RES_ID, IOWA_LWM2M_TYPE_BOOLEAN, IOWA_OPERATION_READ,                        IOWA_RESOURCE_FLAG_NONE},                                      \
    {SAMPLE_OBJECT_STRING_RES_ID,  IOWA_LWM2M_TYPE_STRING,  IOWA_OPERATION_READ,                        IOWA_RESOURCE_FLAG_MANDATORY | IOWA_RESOURCE_FLAG_STREAMABLE}, \
    {SAMPLE_OBJECT_INTEGER_RES_ID, IOWA_LWM2M_TYPE_INTEGER, IOWA_OPERATION_READ | IOWA_OPERATION_WRITE, IOWA_RESOURCE_FLAG_NONE}                                       \
}
