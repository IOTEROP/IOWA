...
#define SAMPLE_RES_DESCRIPTION {                                                                              \
    ...
    {5503, IOWA_LWM2M_TYPE_INTEGER, IOWA_OPERATION_READ | IOWA_OPERATION_WRITE, IOWA_RESOURCE_FLAG_MULTIPLE}  \
}
...
{
    bool  booleanValue;
    int  integerValueRes1;
    int  integerValueRes2;
    int  integerValueRes3;
    int  integerValueRes6;
    char *stringValue;
